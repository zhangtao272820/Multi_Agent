...
ADMIN_SCENARIO_PLAYBOOK: list[AdminScenarioPlaybookEntry] = [
    ...
    },
    {
        ...
        "intent_hint": "邮件",
        "tool_hint": "list_email_attachments",
    },
    {
        "id": "email_classify",
        "paraphrases": [
            "给收件箱邮件打标签分类",
            "把邮件分成工作社交通知",
            "classify my inbox emails",
            "邮件分类一下",
        ],
        "intent_hint": "邮件",
        "tool_hint": "classify_emails",
    },
    {
        "id": "meeting_prep",
        "paraphrases": [
    ...
    },
    {
        ...
        "paraphrases": [
            ...
            "内部资料里搜",
            "公司文档检索",
            "rag search our knowledge base",
        ],
        "intent_hint": "搜索",
        "tool_hint": "knowledge_retrieval",
    },
    {
        "id": "calendar_list",
        "paraphrases": [
