...
CURATED: dict[str, dict] = {
    # ========== T1 yeyu ==========
    "story_yeyu_act1_counter": {
        "route_beat": "便利店拌嘴→看见针眼→雨夜收工→夜班柜台被记住",
        "route_sprites": ["work", "casual", "rain", "tape_measure"],
        "beats": [
            {
                "id": "b1",
                "summary": "夜班柜台她毒舌点单；灯光下你第一次看见她手指上的针眼。",
                "sprite_hint": ["work", "tape_measure"],
                "soft_options": ["问针眼怎么来的", "回一句毒舌", "安静付钱"],
            },
            {
                "id": "b2",
                "summary": "她掩饰说「针线活而已」；话里全是不愿被可怜的硬壳。",
                "sprite_hint": ["tape_measure", "work"],
                "soft_options": ["说不可怜只好奇", "问她白天做什么", "买关东煮分她"],
            },
            {
                "id": "b3",
                "summary": "打烊雨夜，她把扫把往你这边一丢：难得有人不被她吓跑。",
                "sprite_hint": ["rain", "fabric_drape"],
                "soft_options": ["帮她收工", "约下次再来吵", "撑伞送她一程"],
            },
        ],
    },
    "story_yeyu_act2_atelier": {
        "route_beat": "人台别针→量体距离→布料披肩→毒舌下的第一次信任",
        "route_sprites": ["mannequin_pin", "fabric_drape", "look_sketch", "pattern_cut"],
        "beats": [
            {
                "id": "b1",
                "summary": "工房人台上密布别针；她让你别乱动，语气凶得像在怕出错。",
                "sprite_hint": ["mannequin_pin", "work"],
                "soft_options": ["站好当模特", "夸别针很稳", "问能不能帮忙"],
            },
            {
                "id": "b2",
                "summary": "软尺绕过肩线时她停住：量体太近，毒舌忽然接不上。",
                "sprite_hint": ["tape_measure", "fabric_drape"],
                "soft_options": ["别乱动配合", "轻声说放松", "问她紧张吗"],
            },
            {
                "id": "b3",
                "summary": "她把半成品披你肩上画线稿：第一次把未完成的自己交给你看。",
                "sprite_hint": ["look_sketch", "fabric_drape"],
                "soft_options": ["认真当衣架", "夸线条干净", "保证不乱碰布"],
            },
            {
                "id": "b4",
                "summary": "收工灯灭一半；她骂你「别得意」——信任已经漏出来了。",
                "sprite_hint": ["pattern_cut", "casual"],
                "soft_options": ["笑着答应保密", "约下次试穿", "说想学剪线头"],
            },
        ],
    },
    "story_yeyu_act3_hem": {
        "route_beat": "熨折边→为你改的那寸→告白藏在针脚里→锋利温柔落地",
        "route_sprites": ["iron_hem", "tape_measure", "pattern_cut", "date"],
        "beats": [
            {
                "id": "b1",
                "summary": "熨斗蒸汽里她专心跳折边，说这件「不是客户单」。",
                "sprite_hint": ["iron_hem", "work"],
                "soft_options": ["问是给谁的", "递镇纸帮忙", "安静看她做完"],
            },
            {
                "id": "b2",
                "summary": "软尺在你腰侧比了一寸：为你留的折边，差这一步就成成衣。",
                "sprite_hint": ["tape_measure", "pattern_cut"],
                "soft_options": ["问为何替你做", "说想穿给她看", "怕奢求先道谢"],
            },
            {
                "id": "b3",
                "summary": "她别过脸：喜欢就直说，别把她的认真当成免费改衣服务。",
                "sprite_hint": ["iron_hem", "date"],
                "soft_options": ["坦白喜欢", "说珍惜她的针脚", "问能不能交往"],
            },
            {
                "id": "b4",
                "summary": "最后一针收线；她把成衣塞你怀里——锋利的温柔，终于落地。",
                "sprite_hint": ["date", "casual"],
                "soft_options": ["穿上给她看", "抱住道谢", "约下次量新尺寸"],
            },
        ],
    },
    # ========== T1 taotao ==========
