...
assert(multiSys.includes('像 Cursor') || multiSys.includes('Cursor'), 'multi emphasizes Cursor tone')
...
assert(chatWebSys.includes('Cursor') || chatWebSys.includes('拓展'), 'chat_web has conversational extension')
...
assert(stdDbSys.includes('Cursor') || stdDbSys.includes('拓展'), 'std db conversational')
